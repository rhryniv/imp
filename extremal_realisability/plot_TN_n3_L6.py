"""Figure: T_N for N=1,2,5 at n=3, using L=2n=6, the minimal admissible
period (rather than the kappa_min-maximizing L_best=16) -- kappa_B's own
phase winds like L*vartheta/2, so the smallest L minimizes that source
of rippling across I_0. Linear scale, matching the project's established
plotting style.
"""
...
DPS = 60
N_LAYERS = 3
L_BEST = 6  # L=2n, the minimal admissible period
...
def main():
    ...
    ax.set_title(rf"$T_N$ at $n={N_LAYERS}$, minimal period $L=2n={L_BEST}$, $N=1,2,5$")
    ...
    fig.tight_layout()
    fig.savefig("TN_n3_L6.pdf")
    fig.savefig("TN_n3_L6.png", dpi=170)
    print("saved TN_n3_L6.pdf/.png")
