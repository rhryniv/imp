"""Figure: T_N for N=1,2,5 at n=9, using the best configuration found
(L_best=48 from the realisability sweep). Linear scale, matching the
...
DPS = 60
N_LAYERS = 9
L_BEST = 48  # from run_all.py's sweep for n=9
...
def main():
    ...
    fig.tight_layout()
    fig.savefig("TN_n9.pdf")
    fig.savefig("TN_n9.png", dpi=170)
    print("saved TN_n9.pdf/.png")
